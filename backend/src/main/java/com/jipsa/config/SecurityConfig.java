...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // role 변경 감지 시 JwtAuthenticationFilter가 실어 보내는 새 Access/Refresh Token 헤더 —
        // 커스텀 응답 헤더는 노출(expose)하지 않으면 브라우저 JS에서 못 읽는다.
        config.setExposedHeaders(List.of(
                JwtAuthenticationFilter.NEW_ACCESS_TOKEN_HEADER,
                JwtAuthenticationFilter.NEW_REFRESH_TOKEN_HEADER));
