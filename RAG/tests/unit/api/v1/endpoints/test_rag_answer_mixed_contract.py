...
def test_response_json_schema_exposes_public_cited_source_ids() -> None:
    ...
    assert "source_locator" in RagAnswerResponse.model_json_schema()["$defs"][
        "RagAnswerSource"
    ]["properties"]
...
def test_response_mapping_contract_failure_is_exposed_as_invalid_generation() -> None:
    ...
    from jipsa_rag.api.v1.endpoints.rag_answer import (  # noqa: PLC0415
        _convert_rag_answer_service_error,
    )
    from jipsa_rag.core.error_codes import ErrorCode  # noqa: PLC0415
    from jipsa_rag.services.rag_answer import RagAnswerServiceError  # noqa: PLC0415
