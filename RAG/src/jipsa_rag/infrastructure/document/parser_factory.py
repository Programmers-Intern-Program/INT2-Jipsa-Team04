...
from jipsa_rag.infrastructure.ocr import EasyOcrEngine, OcrDocumentEnricher
...
class DocumentParserFactory:
    ...
    호출자가 명시적인 Iterable을 전달하면 설정을 읽지 않고 해당 목록만 등록한다.
    따라서 단위 테스트는 EasyOCR, Microsoft Office COM 또는 CUDA 없이 작은 Stub 파서만 주입할
    수 있다.
    """
    ...
    def __init__(
        ...
        *,
        ...
        if parsers is None:
            ...
            registered_parsers = self._build_default_parsers(processing_settings)
        else:
